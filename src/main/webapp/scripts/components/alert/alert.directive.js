        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('versionmonitorApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-versionmonitorApp-error');
                                var entityKey = httpResponse.headers('X-versionmonitorApp-params');
                                if (errorHeader) {
