...
import net.evenh.versionmonitor.security.SecurityUtils;
import net.evenh.versionmonitor.services.MailService;
import net.evenh.versionmonitor.services.UserService;
import net.evenh.versionmonitor.web.rest.dto.KeyAndPasswordDTO;
import net.evenh.versionmonitor.web.rest.dto.UserDTO;
...
public class AccountResource {
   ...
   * @return the ResponseEntity with status 201 (Created) if the user is registred or 400 (Bad
   ...
   * Request) if the e-mail address is not registred
   */
